...
{  
   //load double DeltaCIndicatorHistory[] with delta c M5 history for 10 candles
   //GetIndicatorHistory(22, 10);//based on 5 minute data
   GetIndicatorHistory(32, 10);//based on 1 minute data
